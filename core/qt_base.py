...
class GLWidget(QtOpenGL.QGLWidget):
    def __init__(self,parent:QtWidgets.QWidget=None,resolution:list=[800,600],
                 background_color:list= [0.0,0.0,0.0],show_fps:bool=True,
                 display_grid:bool = False,static_camera:bool = False,major_version:int=3,minor_version:int=3):
        super().__init__(parent)
    ...
    def paintGL(self):
        # pass
         ...
         print(f"FPS: {self._fps_counter._fps:.2f}")
        #  self.setContext
...
class QGLTestWindow(QtWidgets.QMainWindow):
    def __init__(self,clear_color:list=[0.0, 0.0, 0.0], title:str="Test",display_grid:bool=True,static_camera:bool=False)-> None:
        super().__init__()
        self.gl_widget = GLWidget(self,background_color=clear_color,display_grid=True,static_camera=False)
